...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Mpel Melitpolski', 'mpel@ubermelon.com')
    False
    >>> is_mel('Mel Melitpolski', 'cmepl@ubermelon.com')
    True
    >>> is_mel('cMepl Melitpolski', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    (None, None)
    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'dessert'},{'type': 'fruit'}]) 
    ('dessert', 'fruit')
    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'}])
    ('dessert', 'dessert')
    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'fruit'}])
    ('dessert', 'dessert')

    # >>> type(('desert' , 'fruit')) is tuple
    # True

    >>> type(most_and_least_common_type([{'type': 'dessert'}]))
    <class 'tuple'>
    """
    types = {}
